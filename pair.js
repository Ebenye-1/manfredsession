            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'MANFRED-MD-V1~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029VaqL0196WaKvp1iZx70K) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [https://github.com/Ebenye-1/MANFRED-MD-V1/)  

🇨🇲 _Thanks for choosing MANFRED-MD-V1 — Let the automation begin!_ ✨`;
